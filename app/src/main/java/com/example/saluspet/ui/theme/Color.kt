...
// 🎨 Paleta de Colores Pastel de SalusPet
val PastelGreenPrimary = Color(0xFFA8E6CF)      // Verde para botones y acentos (como en la imagen)
val PastelGreenDark = Color(0xFF7CB3A1)         // Variante más oscura
